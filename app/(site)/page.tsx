    ...
    <main className="flex flex-col min-h-screen bg-black text-white">
      ...
      <section className="w-full py-12 sm:py-16 lg:py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-12 relative z-10">
          ...
          {/* Lo ponemos full-width debajo de los widgets para darle importancia visual */}
      ...
      {/* 3. TIANGUIS & APRENDE CARDS (Existing Content) */}
      <section className="w-full py-12 bg-slate-950/50 border-t border-white/5">
