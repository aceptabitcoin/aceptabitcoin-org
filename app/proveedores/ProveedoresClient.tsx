...
export default function ProveedoresClient({ proveedores }: ProveedoresClientProps) {
  ...
  // Mínimo 600ms para transición suave de skeletons
  useEffect(() => {
    ...
    <>
      ...
      <main className="min-h-screen bg-black relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-32 pb-20">
          ...
          {/* ═══════════════════════════════════════════════════════
              HEADER (font-serif títulos, font-mono datos)
              ═══════════════════════════════════════════════════════ */}
          <div className="text-center mb-16 space-y-6">
            <div className="inline-flex items-center gap-2 bg-matrix/10 border border-matrix/30 px-4 py-1.5 rounded-full text-matrix text-[10px] font-bold uppercase tracking-[0.2em] font-mono">
              <Globe className="h-3 w-3" /> Directorio Sovereign
            </div>
            <h1 className="font-serif text-4xl md:text-6xl font-bold text-white leading-tight">
              Proveedores{" "}
              <span className="text-bitcoin drop-shadow-[0_0_25px_rgba(247,147,26,0.5)]">Bitcoin</span>
            </h1>
          ...
          <div className="space-y-6 mb-12">
            <div className="relative max-w-md mx-auto">
              ...
              <input
                type="text"
                placeholder="Buscar proveedores, ubicación o servicios..."
                value={searchQuery}
          ...
          {/* ═══════════════════════════════════════════════════════
              RESULTS COUNT (font-mono terminal style)
              ═══════════════════════════════════════════════════════ */}
          ...
          {/* ═══════════════════════════════════════════════════════
              GRID (ProviderCard / Skeleton / Empty)
              ═══════════════════════════════════════════════════════ */}
            ...
            {loading ? (
              ...
              <div className="col-span-full text-center py-20 bg-black/40 border border-white/10 rounded-lg backdrop-blur-sm">
                ...
                <p className="font-mono text-sm text-gray-500 mb-2">
                  No se encontraron proveedores{searchQuery && <span className="text-bitcoin"> para "{searchQuery}"</span>}
                </p>
                <button
          ...
          {/* ═══════════════════════════════════════════════════════
              FOOTER CTA (font-vt323 + Bitcoin Orange glow)
              ═══════════════════════════════════════════════════════ */}
